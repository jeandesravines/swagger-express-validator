...
class App {
  ...
  initializeMiddlewares(middleware) {
    ...
    mapping.set("swaggerRouter", () => this.router.middleware);
    mapping.set("requestHandler", () => RequestHandler.middleware);
    mapping.set("requestPerformer", () => RequestPerformer.middleware);
    mapping.set("responseValidator", () => ResponseValidator.middleware);
    mapping.set("responseSender", () => ResponseSender.middleware);
    mapping.set("errorHandler", () => ErrorHandler.middleware);
